...
1. Running: Buses currently traversing a route.
2. Return Ready: Buses idle at the destination waiting to begin the reverse route.
3. Completed: Total concluded trips.
4. Offline: Unassigned or deactivated buses.
