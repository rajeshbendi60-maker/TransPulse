...
1. Markers glide smoothly using sub-second mathematical interpolation.
2. The actual GTFS road network geometry is securely painted directly onto the map context.
...
1. Completed stops are grayed out.
2. The Active stop illuminates.
3. Remaining stops display dynamically adjusted expected times.
